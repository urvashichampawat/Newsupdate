...
constructor(props){
 ...
 async updateNews(pageNo){
  const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=72902be3906e4bd180acbf40d202ea73&page=${this.state.page}&pageSize=${this.props.pageSize}`;
